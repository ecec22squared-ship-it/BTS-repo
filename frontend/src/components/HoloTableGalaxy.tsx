...
const SYSTEMS = [
  { name: 'Coruscant', x: 0.50, y: 0.48, size: 4 },
  { name: 'Corellia', x: 0.42, y: 0.55, size: 3 },
  { name: 'Nar Shaddaa', x: 0.65, y: 0.60, size: 3 },
  { name: 'Kashyyyk', x: 0.35, y: 0.38, size: 3 },
  { name: 'Ryloth', x: 0.72, y: 0.42, size: 2 },
  { name: 'Kessel', x: 0.78, y: 0.68, size: 2 },
  { name: 'Dathomir', x: 0.22, y: 0.70, size: 2 },
  { name: 'Lothal', x: 0.30, y: 0.25, size: 2 },
  { name: 'Jakku', x: 0.82, y: 0.30, size: 2 },
  { name: 'Takodana', x: 0.55, y: 0.32, size: 2 },
  { name: 'Batuu', x: 0.18, y: 0.50, size: 2 },
  { name: 'Vandor', x: 0.60, y: 0.78, size: 2 },
  { name: 'Ord Mantell', x: 0.40, y: 0.72, size: 2 },
  { name: 'Bracca', x: 0.85, y: 0.52, size: 2 },
  { name: 'Florrum', x: 0.25, y: 0.82, size: 2 },
  { name: 'Mustafar', x: 0.68, y: 0.20, size: 2 },
  { name: 'Naboo', x: 0.48, y: 0.65, size: 2 },
  { name: 'Mandalore', x: 0.58, y: 0.15, size: 2 },
];
